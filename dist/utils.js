...
function getEntities(tweet) {
    ...
    var _tweet_entities_hashtags;
    addEntities(result, 'hashtag', (_tweet_entities_hashtags = tweet.entities.hashtags) != null ? _tweet_entities_hashtags : []);
    var _tweet_entities_user_mentions;
    addEntities(result, 'mention', (_tweet_entities_user_mentions = tweet.entities.user_mentions) != null ? _tweet_entities_user_mentions : []);
    var _tweet_entities_urls;
    addEntities(result, 'url', (_tweet_entities_urls = tweet.entities.urls) != null ? _tweet_entities_urls : []);
    var _tweet_entities_symbols;
    addEntities(result, 'symbol', (_tweet_entities_symbols = tweet.entities.symbols) != null ? _tweet_entities_symbols : []);
